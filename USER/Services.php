...
<body class="venue-page-page">
    ...
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>GALLARY</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="Photo-gallary.php">Photo Gallary</a></li>
              <li><a href="#">Video Gallary</a></li>
              <li><a href="#">Wedding album</a></li>
            </ul>
          </li>
  ...
  <main class="main">
        ...
        <section class="venue-parallax">
        <div class="overlay">
          <div class="container text-center">
            <h1>Best Event & Wedding <br>Venues in Gujarat</h1>
            <p>Looking for a perfect venue in Gujarat? Our updated list features the most stunning locations and
                 venue types, from backwater and beach resorts to banquet halls and traditional local mandapas.
                  Find your dream event venue in Gujarat today! </p>
          </div>
        </div>
      </section>
